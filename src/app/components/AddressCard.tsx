...
const AddressCard: React.FC = () => {
  ...
  return (
    <div className="card_2 flex-shrink-0 w-full md:w-[21.8125rem] h-[611px] bg-white shadow-[0_1px_5px_0_rgba(45,62,80,0.12)] flex flex-col relative ml-0 p-0">
      {/* Orange vertical bar */}
      ...
      <div className="pl-6 pr-4 py-6 flex flex-col justify-between h-full gap-0">
        <div>
          ...
          <div className="text-[#33475b] font-poppins-regular leading-6 mb-3 mt-2">
