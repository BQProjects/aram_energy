...
export default function Footer() {
  return (
    <footer className="w-full bg-black text-white py-8 px-8">
      <div
        className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-start gap-2 min-w-[180px]">
          <span className="font-medium text-lg">+49 5251 4032589</span>
          <span
            className="text-sm"
            style={{
              fontSize: 12,
        ...
        {/* Address Section */}
        <div className="flex flex-col items-start gap-2 min-w-[180px]">
          <span className="font-medium text-lg">Paderborn,</span>
          <span className="text-lg">Deutschland</span>
