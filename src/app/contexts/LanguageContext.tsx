...
const translations = {
  en: {
    ...
    "impressum.companyInfo":
      "Information according to §5 TMG\nAram Energy Service\nHorner Str. 11\n33102 Paderborn\nPhone: 0 52 51 / 4032589\n\nE-Mail: Support@aram-energy-Solution.com\nManaging Director: Marauge Aslan\nCourt of Registry: Amtsgericht Paderborn\nRegistration Number: 05774032\nVAT ID according to §27 a UStG: DE455341595\nResponsibility according to § 6 MDStV: Marauge Aslan\nEU Commission's Online Dispute Resolution Platform: http://ec.europa.eu/consumers/odr\nWeb design and implementation: Brain Quest (www.brainquest.org)\nImage credits: Brain Quest",
    "impressum.disclaimer":
      "Disclaimer\nLiability for Content\nAs a service provider, we are responsible for our own content on these pages in accordance with general laws pursuant to § 7 Abs.1 TMG. Pursuant to §§ 8 to 10 TMG, however, as a service provider we are not obligated to monitor transmitted or stored third-party information or to investigate circumstances that indicate illegal activity. Obligations to remove or block the use of information pursuant to general laws remain unaffected. However, liability in this respect is only possible from the time of knowledge of a specific legal violation. Upon becoming aware of corresponding legal violations, we will remove this content immediately.\nLiability for Links\nOur offer contains links to external websites of third parties, over whose contents we have no influence. Therefore, we cannot assume any liability for these external contents. The respective provider or operator of the pages is always responsible for the contents of the linked pages. The linked pages were checked for possible legal violations at the time of linking. Illegal contents were not recognizable at the time of linking. However, a permanent content control of the linked pages is not reasonable without concrete evidence of a violation. Upon becoming aware of legal violations, we will remove such links immediately.\nCopyright\nThe contents and works on these pages created by the site operators are subject to German copyright law. The reproduction, processing, distribution and any kind of exploitation outside the limits of copyright law require the written consent of the respective author or creator. Downloads and copies of this site are only permitted for private, non-commercial use. Insofar as the contents on this site were not created by the operator, the copyrights of third parties are observed. In particular, third-party content is marked as such. Should you nevertheless become aware of a copyright infringement, we ask for a corresponding note. Upon becoming aware of legal violations, we will remove such content immediately.",
    ...
    // Confirmation Page
    "confirm.title": "Confirm Your Energy Contract Application",
    "confirm.calculationTariff": "Calculation Tariff",
    "confirm.selectedTariff": "Selected Tariff",
    "confirm.personalDetails": "Personal Details",
    "confirm.paymentInfo": "Payment Information",
    "confirm.selected": "Selected",
    "confirm.customerType": "Customer Type",
    "confirm.postalCode": "Postal Code",
    "confirm.annualConsumption": "Annual Consumption",
    "confirm.postalOptions": "Postal Options",
    "confirm.basePrice": "Base Price",
    "confirm.laborPrice": "Labor Price",
    "confirm.typeOfCurrent": "Type of Current",
    "confirm.contractTerm": "Contract Term",
    "confirm.priceGuarantee": "Price Guarantee",
    "confirm.downPayment": "Down Payment",
    "confirm.total": "Total",
    "confirm.name": "Name",
    "confirm.surname": "Surname",
    "confirm.email": "Email",
    "confirm.birthDate": "Date of Birth",
    "confirm.mobile": "Mobile No",
    "confirm.address": "Address",
    "confirm.iban": "IBAN",
    "confirm.accountHolder": "Account Holder",
    "confirm.button": "Confirm Application",
    "confirm.processing": "Processing...",
    "confirm.reviewText":
      "Please review all information carefully before confirming your application.",
    "confirm.confirmed.title": "Application Confirmed!",
    "confirm.confirmed.message":
      "Thank you for confirming your energy contract application. We will process your request and contact you soon.",
    ...
    "privacy.overview.item3": "Why we collect this data",
    "privacy.overview.item4": "To whom we share the data",
    "privacy.overview.item5": "Where the data is stored",
    "privacy.overview.item6": "How long the data is retained",
    "privacy.overview.item7": "How we protect the data",
  ...
  de: {
    ...
    // Impressum
    "impressum.companyInfo":
      "Angaben gemäß §5 TMG\nAram Energy Service\nHorner Str. 11\n33102 Paderborn\nTelefon: 0 52 51 / 4032589\n\nE-Mail: Support@aram-energy-Solution.com\nGeschäftsführer: Marauge Aslan\nRegistergericht: Amtsgericht Paderborn\nRegisternummer: 05774032\nUsSt.-Id.-Nr. gemäß §27 a UStG: DE455341595\nVerantwortlichkeit gemäß § 6 MDStV: Marauge Aslan\nPlattform der EU-Kommission zur Online-Streitbeilegung: http://ec.europa.eu/consumers/odr\nWebdesign und Umsetzung: Brain Quest (www.brainquest.org)\nBildnachweise: Brain Quest",
    "impressum.disclaimer":
    ...
    // Confirmation Page (Bestätigungsseite)
    "confirm.title": "Bestätigen Sie Ihren Energievertrag-Antrag",
    "confirm.calculationTariff": "Berechnungstarif",
    "confirm.selectedTariff": "Ausgewählter Tarif",
    "confirm.personalDetails": "Persönliche Daten",
    "confirm.paymentInfo": "Zahlungsinformationen",
    "confirm.selected": "Ausgewählt",
    "confirm.customerType": "Kundentyp",
    "confirm.postalCode": "Postleitzahl",
    "confirm.annualConsumption": "Jahresverbrauch",
    "confirm.postalOptions": "Postalische Optionen",
    "confirm.basePrice": "Grundpreis",
    "confirm.laborPrice": "Arbeitspreis",
    "confirm.typeOfCurrent": "Stromart",
    "confirm.contractTerm": "Vertragslaufzeit",
    "confirm.priceGuarantee": "Preisgarantie",
    "confirm.downPayment": "Anzahlung",
    "confirm.total": "Gesamt",
    "confirm.name": "Name",
    "confirm.surname": "Nachname",
    "confirm.email": "E-Mail",
    "confirm.birthDate": "Geburtsdatum",
    "confirm.mobile": "Mobilnummer",
    "confirm.address": "Adresse",
    "confirm.iban": "IBAN",
    "confirm.accountHolder": "Kontoinhaber",
    "confirm.button": "Antrag bestätigen",
    "confirm.processing": "Wird verarbeitet...",
    "confirm.reviewText":
      "Bitte überprüfen Sie alle Informationen sorgfältig, bevor Sie Ihren Antrag bestätigen.",
    "confirm.confirmed.title": "Antrag bestätigt!",
    "confirm.confirmed.message":
      "Vielen Dank für die Bestätigung Ihres Energievertrag-Antrags. Wir werden Ihre Anfrage bearbeiten und uns bald bei Ihnen melden.",
    "confirm.returnHome": "Zur Startseite",
    "confirm.error.title": "Fehler",
    "confirm.loading": "Lädt...",
    ...
    "privacy.overview.item3": "Warum wir diese Daten erfassen",
    "privacy.overview.item4": "An wen wir die Daten weitergeben",
    "privacy.overview.item5": "Wo die Daten gespeichert werden",
