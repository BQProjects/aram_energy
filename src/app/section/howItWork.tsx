  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto pt-12 sm:pt-16 md:pt-20 lg:pt-[60px] px-4 sm:px-6 md:px-8 lg:px-24 flex flex-col items-center sm:items-start">
        ...
        <div className="text-white font-inria-serif-regular text-2xl sm:text-3xl md:text-2xl mb-4 sm:mb-5 text-center sm:text-left">
          {t("howItWorks.solarEnergy")}
        </div>
        <div className="text-white font-inria-serif-regular text-base sm:text-lg md:text-lg mb-6 sm:mb-7 leading-relaxed max-w-4xl text-center sm:text-left">
